  ...
  <div class="collapse navbar-collapse" id="navbar-list-4"> -->
    <ul class="navbar-nav justify-content-end">
        ...
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <img src="https://th.bing.com/th/id/OIP.N-r26YWGUXWWmHGrZBOLbgHaHa?w=200&h=200&c=7&o=5&pid=1.7" width="40" height="40" class="rounded-circle">
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <!-- <a class="dropdown-item" href="update1.php">Edit Profile</a> -->
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                                <div class="class-thumb">
                                    ...
                                    <form action="yogapay.php" method="POST">
                            ...
                            <div class="mt-5 mt-lg-0 mt-md-0 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                                <div class="class-thumb">
                                    ...
                                    <div class="class-info">
                                        ...
                                        <span><strong>***************</strong></span>
                                        <form action="aeriobicpay.php" method="POST">
                                        <button>
                                        <span class="class-price">790/-</span>
                                        </button>
                                        </form>
                            ...
                            <div class="mt-5 mt-lg-0 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="600">
                                <div class="class-thumb">
                                    ...
                                    <div class="class-info">
                                        ...
                                        <form action="cardiopay.php" method="POST">
                                        <button>
                                        <span class="class-price">790/-</span>
                                        </button>
                                        </form>
      ...
      <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="membership-form webform" role="form" action="stripepay.php" method="POST">
